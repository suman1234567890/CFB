...
<body style="height:650;width:100%;" >
<%
...
<div style="height:90%;width:90%;border-color: black;border-style:groove;margin:3%">
  	...
  	while(rs2.next())
  		{%>
  		<label  style='margin:50px; font: 900;font-size:large'><%=rs2.getString(1) %></label>
  		<%} %>
  	</div>
  	<div>
  		<input align="middle" type='submit' value='submit' style="width:100px;height:30px;"/>
  	</div>
